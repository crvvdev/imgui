...
// Helpers: Sorting
#ifndef ImQsort
static inline void      ImQsort(void* base, size_t count, size_t size_of_element, int(IMGUI_CDECL* compare_func)(void const*, void const*)) { if (count > 1) IMGUI_QSORT(base, count, size_of_element, compare_func); }
#endif
...
#define ImFabs(X)           IMGUI_FABS(X)
#define ImFabsf(X)          IMGUI_FABSF(X)
...
#define ImCeil(X)           IMGUI_CEIL(X)
    static inline float  ImPow(float x, float y) { return IMGUI_POWF(x, y); }          // DragBehaviorT/SliderBehaviorT uses ImPow with either float/double and need the precision
static inline double ImPow(double x, double y) { return IMGUI_POW(x, y); }
static inline float  ImLog(float x) { return IMGUI_LOGF(x); }             // DragBehaviorT/SliderBehaviorT uses ImLog with either float/double and need the precision
static inline double ImLog(double x) { return IMGUI_LOG(x); }
static inline int    ImAbs(int x) { return x < 0 ? -x : x; }
static inline float  ImAbs(float x) { return ImFabsf(x); }
static inline double ImAbs(double x) { return ImFabs(x); }
...
#endif
static inline double ImRsqrt(double x) { return 1.0 / IMGUI_SQRT(x); }
#endif
...
inline float         ImTriangleArea(const ImVec2& a, const ImVec2& b, const ImVec2& c) { return ImFabsf((a.x * (b.y - c.y)) + (b.x * (c.y - a.y)) + (c.x * (a.y - b.y))) * 0.5f; }
...
inline void     ImBitArrayClearAllBits(ImU32* arr, int bitcount) { IMGUI_MEMSET(arr, 0, ImBitArrayGetStorageSizeInBytes(bitcount)); }
...
struct ImBitArray
{
    ...
    void            ClearAllBits() { IMGUI_MEMSET(Storage, 0, sizeof(Storage)); }
    void            SetAllBits() { IMGUI_MEMSET(Storage, 255, sizeof(Storage)); }
...
struct IMGUI_API ImBitVector
{
    ...
    void            Create(int sz) { Storage.resize((sz + 31) >> 5); IMGUI_MEMSET(Storage.Data, 0, (size_t)Storage.Size * sizeof(Storage.Data[0])); }
...
struct ImSpanAllocator
{
    ...
    ImSpanAllocator() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
...
struct ImDrawDataBuilder
{
    ...
    ImDrawDataBuilder() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiComboPreviewData
{
    ...
    ImGuiComboPreviewData() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiMenuColumns
{
    ...
    ImGuiMenuColumns() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
...
struct IMGUI_API ImGuiInputTextDeactivatedState
{
    ...
    ImGuiInputTextDeactivatedState() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
...
struct IMGUI_API ImGuiInputTextState
{
    ...
    ImGuiInputTextState() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
...
struct ImGuiNextWindowData
{
    ...
    ImGuiNextWindowData() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
...
struct ImGuiNextItemData
{
    ...
    ImGuiNextItemData() { IMGUI_MEMSET(this, 0, sizeof(*this)); SelectionUserData = -1; }
...
struct ImGuiLastItemData
{
    ...
    ImGuiLastItemData() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiStackSizes
{
    ...
    ImGuiStackSizes() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
...
struct ImGuiPopupData
{
    ...
    ImGuiPopupData() { IMGUI_MEMSET(this, 0, sizeof(*this)); ParentNavLayer = OpenFrameCount = -1; }
};
...
struct ImGuiInputEvent
{
    ...
    ImGuiInputEvent() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
};
...
struct ImGuiListClipperData
{
    ...
    ImGuiListClipperData() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
...
struct IMGUI_API ImGuiTypingSelectState
{
    ...
    ImGuiTypingSelectState() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
...
struct ImGuiOldColumnData
{
    ...
    ImGuiOldColumnData() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
};
...
struct ImGuiOldColumns
{
    ...
    ImGuiOldColumns() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
};
...
struct ImGuiWindowSettings
{
    ...
    ImGuiWindowSettings() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
...
struct ImGuiSettingsHandler
{
    ...
    ImGuiSettingsHandler() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
};
...
struct ImGuiDebugAllocInfo
{
    ...
    ImGuiDebugAllocInfo() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
};
...
struct ImGuiStackLevelInfo
{
    ...
    ImGuiStackLevelInfo() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
};
...
struct ImGuiIDStackTool
{
    ...
    ImGuiIDStackTool() { IMGUI_MEMSET(this, 0, sizeof(*this)); CopyToClipboardLastTime = -FLT_MAX; }
};
...
struct ImGuiContextHook
{
    ...
    ImGuiContextHook() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
};
...
struct ImGuiContext
{
    ...
    ImGuiContext(ImFontAtlas* shared_font_atlas)
    {
        ...
        IMGUI_MEMSET(DragDropPayloadBufLocal, 0, sizeof(DragDropPayloadBufLocal));
        ...
        IMGUI_MEMSET(LocalizationTable, 0, sizeof(LocalizationTable));
        ...
        IMGUI_MEMSET(FramerateSecPerFrame, 0, sizeof(FramerateSecPerFrame));
        FramerateSecPerFrameIdx = FramerateSecPerFrameCount = 0;
        FramerateSecPerFrameAccum = 0.0f;
        WantCaptureMouseNextFrame = WantCaptureKeyboardNextFrame = WantTextInputNextFrame = -1;
        IMGUI_MEMSET(TempKeychordName, 0, sizeof(TempKeychordName));
    }
};
...
struct IMGUI_API ImGuiWindow
{
    ...
    int                     NameBufLen;                         // Size of buffer storing Name. May be larger than IMGUI_STRLEN(Name)!
...
struct ImGuiTabItem
{
    ...
    ImGuiTabItem() { IMGUI_MEMSET(this, 0, sizeof(*this)); LastFrameVisible = LastFrameSelected = -1; RequestedWidth = -1.0f; NameOffset = -1; BeginOrder = IndexDuringLayout = -1; }
};
...
struct IMGUI_API ImGuiTable
{
    ...
    ImGuiTable() { IMGUI_MEMSET(this, 0, sizeof(*this)); LastFrameActive = -1; }
...
struct IMGUI_API ImGuiTableTempData
{
    ...
    ImGuiTableTempData() { IMGUI_MEMSET(this, 0, sizeof(*this)); LastTimeActive = -1.0f; }
};
...
struct ImGuiTableSettings
{
    ...
    ImGuiTableSettings() { IMGUI_MEMSET(this, 0, sizeof(*this)); }
